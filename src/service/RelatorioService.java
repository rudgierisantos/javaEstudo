...
public class RelatorioService implements Serializable {
	...
	public String gerarRelatorio(List<?> listaDataBeanCollection,
			HashMap parametrosRelatorio, String nomeRelatorioJasper,
			String nomeRelatorioSaida, ServletContext servletContext,
			String tipoExportar) throws Exception {
		...
		if (caminhoRelatorio == null || caminhoRelatorio != null
				&& caminhoRelatorio.isEmpty() || !file.exists()) {
		...
		String caminhoArquivosJasper = caminhoRelatorio + SEPARATOR
		...
		caminhoArquivorelatorio = caminhoRelatorio + SEPARATOR
				+ nomeRelatorioSaida + "." + tipoExportar;
